...
Write-Host ""
Write-Host "  바로 테스트:"
Write-Host '    New-Item -ItemType Directory -Force "$HOME\project\ace-smoke" | Out-Null; Set-Location "$HOME\project\ace-smoke"; ace init --pack dev --stack nextjs-fastapi-pg --mode solo; ace'
Write-Host ""
